...
package gestao_riscos.run_staging_0_1;
...
/**
 * Job: RUN_STAGING Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class RUN_STAGING implements TalendJob {
...
public String getSTG_USER(){
	...
	private final String jobName = "RUN_STAGING";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RUN_STAGING.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_3_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_de_para_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(classpath_tRunJob_3_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "gestao_riscos.stg_arq_riscos_de_para_0_1.STG_ARQ_RISCOS_DE_PARA");
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      					...
		      					String classpath_tRunJob_3_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_de_para_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    ...
                    parentContextMap_tRunJob_3.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_3.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_1_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_estrut_op_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "gestao_riscos.stg_arq_riscos_estrut_op_0_1.STG_ARQ_RISCOS_ESTRUT_OP");
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");
		      					...
		      					String classpath_tRunJob_1_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_estrut_op_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_1.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
			...
			if (osName_tRunJob_4 != null && osName_tRunJob_4.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_4_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_dolar_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, dealChildJobLibrary_tRunJob_4.replaceJarPathsFromCrcMap(classpath_tRunJob_4_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "gestao_riscos.stg_arq_riscos_dolar_0_1.STG_ARQ_RISCOS_DOLAR");
		      					...
		      					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "-cp");
		      					...
		      					String classpath_tRunJob_4_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_dolar_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_4.put("DW_DBNAME", context.DW_DBNAME);
                    paraList_tRunJob_4.add("--context_type " + "DW_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("DW_HOST", context.DW_HOST);
                    paraList_tRunJob_4.add("--context_type " + "DW_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("DW_PORT", context.DW_PORT);
                    paraList_tRunJob_4.add("--context_type " + "DW_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("DW_PWD", context.DW_PWD);
                    paraList_tRunJob_4.add("--context_type " + "DW_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_4.put("DW_USER", context.DW_USER);
                    paraList_tRunJob_4.add("--context_type " + "DW_USER" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("CAMINHO_ARQUIVO_IMPORT", context.CAMINHO_ARQUIVO_IMPORT);
                    paraList_tRunJob_4.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_4.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("DATAHORAPROCESSAMENTO", context.DATAHORAPROCESSAMENTO);
                    paraList_tRunJob_4.add("--context_type " + "DATAHORAPROCESSAMENTO" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("STG_DBNAME", context.STG_DBNAME);
                    paraList_tRunJob_4.add("--context_type " + "STG_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("STG_HOST", context.STG_HOST);
                    paraList_tRunJob_4.add("--context_type " + "STG_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("STG_PORT", context.STG_PORT);
                    paraList_tRunJob_4.add("--context_type " + "STG_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("STG_PWD", context.STG_PWD);
                    paraList_tRunJob_4.add("--context_type " + "STG_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_4.put("STG_USER", context.STG_USER);
                    paraList_tRunJob_4.add("--context_type " + "STG_USER" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
			...
			if (osName_tRunJob_5 != null && osName_tRunJob_5.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_5_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_ethanol_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, dealChildJobLibrary_tRunJob_5.replaceJarPathsFromCrcMap(classpath_tRunJob_5_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "gestao_riscos.stg_arq_riscos_ethanol_0_1.STG_ARQ_RISCOS_ETHANOL");
		      					...
		      					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "-cp");
		      					...
		      					String classpath_tRunJob_5_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_ethanol_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_5 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    ...
                    parentContextMap_tRunJob_5.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_5.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
			...
			if (osName_tRunJob_6 != null && osName_tRunJob_6.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_6.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_6_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_heating_oil_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_6.addArgumentsTo(paraList_tRunJob_6, dealChildJobLibrary_tRunJob_6.replaceJarPathsFromCrcMap(classpath_tRunJob_6_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_6.addArgumentsTo(paraList_tRunJob_6, "gestao_riscos.stg_arq_riscos_heating_oil_0_1.STG_ARQ_RISCOS_HEATING_OIL");
		      					...
		      					jvm_argument_helper_tRunJob_6.addArgumentsTo(paraList_tRunJob_6, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_6.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_6.addArgumentsTo(paraList_tRunJob_6, "-cp");
		      					...
		      					String classpath_tRunJob_6_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_heating_oil_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_6 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_6 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_6.put("DW_DBNAME", context.DW_DBNAME);
                    paraList_tRunJob_6.add("--context_type " + "DW_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("DW_HOST", context.DW_HOST);
                    paraList_tRunJob_6.add("--context_type " + "DW_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("DW_PORT", context.DW_PORT);
                    paraList_tRunJob_6.add("--context_type " + "DW_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("DW_PWD", context.DW_PWD);
                    paraList_tRunJob_6.add("--context_type " + "DW_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_6.put("DW_USER", context.DW_USER);
                    paraList_tRunJob_6.add("--context_type " + "DW_USER" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("CAMINHO_ARQUIVO_IMPORT", context.CAMINHO_ARQUIVO_IMPORT);
                    paraList_tRunJob_6.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_6.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("DATAHORAPROCESSAMENTO", context.DATAHORAPROCESSAMENTO);
                    paraList_tRunJob_6.add("--context_type " + "DATAHORAPROCESSAMENTO" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("STG_DBNAME", context.STG_DBNAME);
                    paraList_tRunJob_6.add("--context_type " + "STG_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("STG_HOST", context.STG_HOST);
                    paraList_tRunJob_6.add("--context_type " + "STG_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("STG_PORT", context.STG_PORT);
                    paraList_tRunJob_6.add("--context_type " + "STG_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("STG_PWD", context.STG_PWD);
                    paraList_tRunJob_6.add("--context_type " + "STG_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_6.put("STG_USER", context.STG_USER);
                    paraList_tRunJob_6.add("--context_type " + "STG_USER" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_sugar_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "gestao_riscos.stg_arq_riscos_sugar_0_1.STG_ARQ_RISCOS_SUGAR");
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      					...
		      					String classpath_tRunJob_2_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_sugar_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    parentContextMap_tRunJob_2.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_2.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
			...
			if (osName_tRunJob_7 != null && osName_tRunJob_7.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_7.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_7_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/ojdbc8-19.3.0.0.jar;../lib/simpleexcel-2.5-20201119.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/filecopy-2.0.3.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/talend-oracle-timestamptz.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;stg_arq_riscos_lauchpad_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_7.addArgumentsTo(paraList_tRunJob_7, dealChildJobLibrary_tRunJob_7.replaceJarPathsFromCrcMap(classpath_tRunJob_7_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_7.addArgumentsTo(paraList_tRunJob_7, "gestao_riscos.stg_arq_riscos_lauchpad_0_1.STG_ARQ_RISCOS_LAUCHPAD");
		      					...
		      					jvm_argument_helper_tRunJob_7.addArgumentsTo(paraList_tRunJob_7, "--context=PRODUCAO");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_7.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_7.addArgumentsTo(paraList_tRunJob_7, "-cp");
		      					...
		      					String classpath_tRunJob_7_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/ojdbc8-19.3.0.0.jar:$ROOT_PATH/../lib/simpleexcel-2.5-20201119.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/filecopy-2.0.3.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/talend-oracle-timestamptz.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/stg_arq_riscos_lauchpad_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_7 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_7.put("DW_DBNAME", context.DW_DBNAME);
                    paraList_tRunJob_7.add("--context_type " + "DW_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("DW_HOST", context.DW_HOST);
                    paraList_tRunJob_7.add("--context_type " + "DW_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("DW_PORT", context.DW_PORT);
                    paraList_tRunJob_7.add("--context_type " + "DW_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("DW_PWD", context.DW_PWD);
                    paraList_tRunJob_7.add("--context_type " + "DW_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_7.put("DW_USER", context.DW_USER);
                    paraList_tRunJob_7.add("--context_type " + "DW_USER" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("CAMINHO_ARQUIVO_IMPORT", context.CAMINHO_ARQUIVO_IMPORT);
                    paraList_tRunJob_7.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("CAMINHO_ARQUIVO_IMPORT_B", context.CAMINHO_ARQUIVO_IMPORT_B);
                    paraList_tRunJob_7.add("--context_type " + "CAMINHO_ARQUIVO_IMPORT_B" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("DATAHORAPROCESSAMENTO", context.DATAHORAPROCESSAMENTO);
                    paraList_tRunJob_7.add("--context_type " + "DATAHORAPROCESSAMENTO" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("STG_DBNAME", context.STG_DBNAME);
                    paraList_tRunJob_7.add("--context_type " + "STG_DBNAME" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("STG_HOST", context.STG_HOST);
                    paraList_tRunJob_7.add("--context_type " + "STG_HOST" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("STG_PORT", context.STG_PORT);
                    paraList_tRunJob_7.add("--context_type " + "STG_PORT" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("STG_PWD", context.STG_PWD);
                    paraList_tRunJob_7.add("--context_type " + "STG_PWD" + "=" + "id_Password");
                    parentContextMap_tRunJob_7.put("STG_USER", context.STG_USER);
                    paraList_tRunJob_7.add("--context_type " + "STG_USER" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
 ...
 */
    ...
    public static void main(String[] args){
        final RUN_STAGING RUN_STAGINGClass = new RUN_STAGING();

        int exitCode = RUN_STAGINGClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = RUN_STAGING.class.getClassLoader().getResourceAsStream("gestao_riscos/run_staging_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RUN_STAGING.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("DW_DBNAME")) {
            ...
            }if (parentContextMap.containsKey("CAMINHO_ARQUIVO_IMPORT_B")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RUN_STAGING");
        }
...
/************************************************************************************************
 *     206651 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 de dezembro de 2025 08:19:25 BRT
 ************************************************************************************************/