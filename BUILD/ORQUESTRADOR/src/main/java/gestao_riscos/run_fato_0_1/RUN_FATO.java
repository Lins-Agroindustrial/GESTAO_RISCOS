...
package gestao_riscos.run_fato_0_1;
...
/**
 * Job: RUN_FATO Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class RUN_FATO implements TalendJob {
...
public String getSTG_USER(){
	...
	private final String jobName = "RUN_FATO";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RUN_FATO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_4 = new java.util.ArrayList<String>();
	        				...
	        				paraList_tRunJob_4.add("--context=PRODUCAO");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    parentContextMap_tRunJob_4.put("CAMINHO_META_TF", context.CAMINHO_META_TF);
                    paraList_tRunJob_4.add("--context_type " + "CAMINHO_META_TF" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_4.put("DATAINICIOBASE", context.DATAINICIOBASE);
                    paraList_tRunJob_4.add("--context_type " + "DATAINICIOBASE" + "=" + "id_String");
	...
	Object obj_tRunJob_4 = null;
		...
		gestao_riscos.ft_riscos_dolar_0_1.FT_RISCOS_DOLAR childJob_tRunJob_4 = new gestao_riscos.ft_riscos_dolar_0_1.FT_RISCOS_DOLAR();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		gestao_riscos.ft_riscos_ethanol_0_1.FT_RISCOS_ETHANOL childJob_tRunJob_5 = new gestao_riscos.ft_riscos_ethanol_0_1.FT_RISCOS_ETHANOL();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_6 = new java.util.ArrayList<String>();
	        				...
	        				paraList_tRunJob_6.add("--context=PRODUCAO");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_6 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_6 {
                    ...
                    parentContextMap_tRunJob_6.put("CAMINHO_META_TF", context.CAMINHO_META_TF);
                    paraList_tRunJob_6.add("--context_type " + "CAMINHO_META_TF" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_6.put("DATAINICIOBASE", context.DATAINICIOBASE);
                    paraList_tRunJob_6.add("--context_type " + "DATAINICIOBASE" + "=" + "id_String");
	...
	Object obj_tRunJob_6 = null;
		...
		gestao_riscos.ft_riscos_heating_oil_0_1.FT_RISCOS_HEATING_OIL childJob_tRunJob_6 = new gestao_riscos.ft_riscos_heating_oil_0_1.FT_RISCOS_HEATING_OIL();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		gestao_riscos.ft_riscos_sugar_0_1.FT_RISCOS_SUGAR childJob_tRunJob_1 = new gestao_riscos.ft_riscos_sugar_0_1.FT_RISCOS_SUGAR();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		gestao_riscos.ft_riscos_launchpad_0_1.FT_RISCOS_LAUNCHPAD childJob_tRunJob_2 = new gestao_riscos.ft_riscos_launchpad_0_1.FT_RISCOS_LAUNCHPAD();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final RUN_FATO RUN_FATOClass = new RUN_FATO();

        int exitCode = RUN_FATOClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = RUN_FATO.class.getClassLoader().getResourceAsStream("gestao_riscos/run_fato_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RUN_FATO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RUN_FATO");
        }
...
/************************************************************************************************
 *     94986 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 de dezembro de 2025 08:20:15 BRT
 ************************************************************************************************/